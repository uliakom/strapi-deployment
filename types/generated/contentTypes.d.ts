...
export interface ApiAdmissionsPageAdmissionsPage extends Schema.SingleType {
  ...
  attributes: {
    ...
    btnform: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    btnpolicy: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    btnadmission: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
